...
class Quality:                                                        
    ...
    def nameQuality(name):
        ...
        if checkName(["(pdtv|hdtv|dsr|tvrip|webweb[-.]?dl|web[-.]?rip).(xvid|x264|h.?264)"], all) and not checkName(["(720|1080)[pi]"], all):
            return Quality.SDTV
        ...
        elif checkName(["720p", "web[-.]?dl|web[-.]?rip", "[xh]\.?264"], all) or checkName(["720p", "itunes", "[xh]\.?264"], all):
            return Quality.HDWEBDL                                                                     
        elif checkName(["1080p", "web[-.]?dl|web[-.]?rip", "[xh]\.?264"], all) or checkName(["1080p", "itunes", "[xh]\.?264"], all):     
            return Quality.FULLHDWEBDL                                                                 
        elif checkName(["720p", "bluray|hddvd", "[xh]\.?264"], all):
            return Quality.HDBLURAY                                                                    
        elif checkName(["1080p", "bluray|hddvd", "[xh]\.?264"], all):
