...
class Quality:                                                        
    ...
    def nameQuality(name):
        ...
        elif checkName(["720p", "web[-.]?dl|web[-.]?rip", "h.?264|x264"], all) or checkName(["720p", "itunes", "h.?264"], all):
            return Quality.HDWEBDL                                                                     
        elif checkName(["1080p", "web[-.]?dl|web[-.]?rip", "h.?264|x264"], all) or checkName(["1080p", "itunes", "h.?264"], all):     
