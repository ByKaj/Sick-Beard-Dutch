...
#            return Quality.UNKNOWN
    ...
    def sceneQuality(name):
        ...
        if checkName(["((pd|hd)tv|dsr|tvrip|web?[-.\w\s]{1}?(dl|rip)).(xvid|[xh].?264)"], all) and not checkName(["(720|1080)[pi]"], all):
            ...
            return Quality.FULLHDTV
        elif checkName(["720p", "web?[-.\w\s]{1}?dl", "h.?264"], all) or checkName(["720p", "itunes", "h.?264"], all):
            return Quality.HDWEBDL
        elif checkName(["1080p", "web?[-.\w\s]{1}?dl", "h.?264"], all) or checkName(["1080p", "itunes", "h.?264"], all):
            return Quality.FULLHDWEBDL
